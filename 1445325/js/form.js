if(window.jQuery == undefined) {
                  document.write("<sc"+"ript src='//octoclean.e-autopay.com/js/jq.js' type='text/javascript'></scr"+"ipt>");
           }
           ...
           function getData(action, objSelect){
               ...
               var url = 'https://octoclean.e-autopay.com/adminka/form_generator/get_form_list.php?';
               if(action == 'region'){
           ...
           function hideElement(obj){
               ...
               switch(type){
                   case 'ea_custom_region':
                       if(obj.checked){
                           jQuery('#ea_product_form_42202 #ea_normal_region select').val('');
             document.getElementById('ea_normal_region').style.display = 'none';
                           ...
                           jQuery('#ea_product_form_42202 #ea_special_region input').val('');
...
window.onload = function(){
   ...
   if (current_domain !== 'octoclean.e-autopay.com') {
   ...
   //
   //     jQuery(function(){
   //             $('.tariffs_info_icons').hover(function () {
   //                 $(this).children().stop(true, true).fadeToggle(300);
   //             });
   //             $('.order_sel').selectric({
   //                 maxHeight: 400
   //             });
   //             $('.wrap-checkbox-label .checkbox_activate')
   //                 .tzCheckbox({labels: ['', '']});
   //             function slideDesc () {
   //                 $('.show_text').hide();
   //                 var obj = $('.hide_desc');
