            ...
            <div class="col-lg-9" >
              ...
              <div class="bg-container" >
                 ...
                 <div class="feedback-answers-questions" >
                    ...
                    <div>
                      <?php echo $ULang->t("Если ваше объявление заблокировано, то попробуйте поискать причину в"); ?> <a href=""><?php echo $ULang->t("Правилах Сервиса"); ?></a>. <?php echo $ULang->t("Найдя причину, устраните нарушение правил и подайте объявление заново."); ?>
                    </div>
                 </div>
                 <div class="feedback-answers-questions" >
                    <p><?php echo $ULang->t("Мой аккаунт заблокирован администрацией"); ?> <i class="las la-angle-down"></i></p>
                    <div>
                      <?php echo $ULang->t("Чаще всего блокировка аккаунта происходит потому, что поведение пользователя не соответствует"); ?> <a href=""><?php echo $ULang->t("Правилам сервиса"); ?></a>, <?php echo $ULang->t("например:"); ?>
                      <ul class="mt10" >
