  ...
  <body data-prefix="<?php echo $config["urlPrefix"]; ?>" data-id-ad="<?php echo $data["ad"]["ads_id"]; ?>" data-id-cat="<?php echo $data["ad"]["category_board_id"]; ?>" >
              ...
              <div class="col-lg-9" >
                   ...
                   <div class="row" >
                     <div class="col-lg-11 col-md-12" >
                       ...
                       <span class="ad-status-label ad-status-label-<?php echo $data["ad"]["ads_status"]; ?> mb10" ><?php echo $Ads->status( $data["ad"]["ads_status"] ); ?></span>
                       <?php } ?>                       
                       <h1 class="h1title word-break" ><?php echo $data["ad"]["ads_title"]; ?></h1>
                       <div class="view-list-status" >
                         
                         <?php if($data["ad"]["ads_auction"]){ ?>
                         <span class="auctionlabel" > <i class="las la-gavel"></i> <?php echo $ULang->t("Аукцион"); ?> </span>
                         <?php } ?>

                         <?php if($data["ad"]["ads_online_view"]){ ?>
                         <span data-tippy-placement="top" title="<?php echo $ULang->t("Продавец готов показать товар/объект по видеозвонку"); ?>" > <?php echo $ULang->t("Онлайн-показ"); ?> </span>
                         <?php } ?>

                       </div>
                     </div>
                     <div class="col-lg-1 text-right d-none d-md-block" >
                        <?php echo $Ads->adActionFavorite($data["ad"], "ad"); ?>
                     </div>
                   </div>
                   ...
                   <div class="variable-photo-gallery" >
                      <?php
                          ...
                          if($data["ad"]["ads_video"]){
                             ?>
                             <div data-pos="<?php echo $key + 1; ?>" data-type="video" >
                                <img src="<?php echo $config["urlPath"] . "/" . $config["media"]["other"] . "/youtube.png"; ?>">
                             </div>
                             <?php
                          }                          
                      ?>                    
                         ...
                         <p class="board-view-price-mobile price-currency" >
                          <?php
                            if($data["ad"]["ads_price"]){
                               echo $Main->price($data["ad"]["ads_price"],$data["ad"]["ads_currency"]); 
                            }else{
                               echo 'Бесплатно';
                            }
                          ?>
                   ...
                   <div class="row mb15" >
                     ...
                     <div class="col-lg-6 col-12" > <?php echo $data["ad"]["city_name"]; ?>, <?php echo $data["ad"]["region_name"]; ?> </div> 
                   </div>
                   ...
                   <div class="row" >
                     ...
                     <div class="col-lg-3 col-4 col-md-3 col-sm-3" ><span class="span-style" ><?php echo $ULang->t("В избранном"); ?></span></div>
                     <div class="col-lg-9 col-8 col-md-9 col-sm-9" >
                       <span class="span-style-height" ><?php echo $Profile->getCountFavorites($data["ad"]["ads_id"]); ?></span>
                     </div>

                     <div class="col-lg-3 col-4 col-md-3 col-sm-3" ><span class="span-style" ><?php echo $ULang->t("Просмотры"); ?></span></div>
                     <div class="col-lg-9 col-8 col-md-9 col-sm-9" >
                       <span class="span-style-height" ><?php echo $Ads->getCountView($data["ad"]["ads_id"]); ?></span>
                     </div>

                     <?php if($_SESSION["profile"]["id"] == $data["ad"]["ads_id_user"]){ ?>
                     <div class="col-lg-3 col-4 col-md-3 col-sm-3" ><span class="span-style" ><?php echo $ULang->t("Кол-во показов"); ?></span></div>
                     <div class="col-lg-9 col-8 col-md-9 col-sm-9" >
                     ...
                     <div class="col-lg-3 col-4 col-md-3 col-sm-3" ><span class="span-style" ><?php echo $ULang->t("Размещено"); ?></span></div>
                     <div class="col-lg-9 col-8 col-md-9 col-sm-9" >
                       <span class="span-style-height" ><?php echo datetime_format($data["ad"]["ads_datetime_add"], false); ?></span>
                     </div>

                     <div class="col-lg-3 col-4 col-md-3 col-sm-3" ><span class="span-style" ><?php echo $ULang->t("Поделиться"); ?></span></div>
                     <div class="col-lg-9 col-8 col-md-9 col-sm-9" >
    ...
    <div class="modal-custom-bg"  id="modal-ad-new" style="display: none;" >
        <div class="modal-custom animation-modal" style="max-width: 880px;" >
          ...
          <div class="row" >
             <div class="col-lg-4" >
               <button class="ads-services-tariffs-btn-order mt30" disabled="" ><?php echo $ULang->t("Подключить"); ?></button>
             </div>             
          </div>
    ...
    <div class="modal-custom-bg bg-click-close" style="display: none;" id="modal-remove-publication" >
        <div class="modal-custom animation-modal" style="max-width: 400px" >
          ...
          <div class="modal-confirm-content" >
              <h4><?php echo $ULang->t("Вы действительно хотите снять объявление с публикации?"); ?></h4>            
          </div>
          ...
          <div class="modal-custom-button" >
             <div>
               <button class="button-style-custom schema-color-button color-blue ads-remove-publication" data-id="<?php echo $data["ad"]["ads_id"]; ?>" ><?php echo $ULang->t("Снять с публикации"); ?></button>
             </div> 
             <div>
