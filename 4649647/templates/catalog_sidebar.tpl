...
<?php echo $Filters->load_filters_catalog( $data["category"]["category_board_id"] , $data["param_filter"]); ?>
...
<div class="form-filter-submit" >
    ...
    <button class="btn-custom action-clear-filter"> <?php echo $ULang->t("Сбросить фильтры"); ?> </button>
    <?php } ?>
</div>
