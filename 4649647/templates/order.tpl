  ...
  <body data-prefix="<?php echo $config["urlPrefix"]; ?>">
                   ...
                   <div class="col-lg-9" >
                    ...
                    <?php 
                      ...
                      if( $data["order"]["secure_id_user_buyer"] == $_SESSION["profile"]["id"] ){
                        ...
                        <span class="order-date" > <?php echo $ULang->t("Заказ создан:"); ?> <?php echo datetime_format($data["order"]["secure_date"]); ?> </span>  
                        <?php if(!$data["review"]){ ?>
                        <button class="btn-custom-mini btn-color-blue mt15 open-modal" data-id-modal="modal-add-review" data-id="<?php echo $data["order"]["secure_id"]; ?>" > <span><?php echo $ULang->t("Оставить отзыв о продавце"); ?></span> </button>                
                        <?php
                        }
                        ...
                        <span class="order-date" > <?php echo $ULang->t("Заказ создан:"); ?> <?php echo datetime_format($data["order"]["secure_date"]); ?> </span>
                        <?php if(!$data["review"]){ ?>
                        <button class="btn-custom-mini btn-color-blue mt15 open-modal" data-id-modal="modal-add-review" data-id="<?php echo $data["order"]["secure_id"]; ?>" > <span><?php echo $ULang->t("Оставить отзыв о покупателе"); ?></span> </button>
                        <?php
                        }
    ...
    <div class="modal-custom-bg bg-click-close" style="display: none;" id="modal-confirm-transfer-goods" >
        <div class="modal-custom animation-modal" style="max-width: 400px" >
          ...
          <div class="modal-custom-button" >
             <div>
               <button class="button-style-custom color-blue confirm-transfer-goods" data-id="<?php echo $data["order"]["secure_id"]; ?>" ><?php echo $ULang->t("Подтвердить"); ?></button>
             </div> 
             <div>
    ...
    <div class="modal-custom-bg bg-click-close" style="display: none;" id="modal-confirm-receive-goods" >
        <div class="modal-custom animation-modal" style="max-width: 400px" >
          ...
          <div class="modal-custom-button" >
             <div>
               <button class="button-style-custom color-blue confirm-receive-goods" data-id="<?php echo $data["order"]["secure_id"]; ?>" ><?php echo $ULang->t("Подтвердить"); ?></button>
             </div> 
             <div>
               <button class="button-style-custom color-light button-click-close" ><?php echo $ULang->t("Отменить"); ?></button>
             </div>                                       
    ...
    <div class="modal-custom-bg bg-click-close" style="display: none;" id="modal-confirm-cancel-order" >
        <div class="modal-custom animation-modal" style="max-width: 400px" >
          ...
          <div class="modal-custom-button" >
             <div>
               <button class="button-style-custom color-blue confirm-cancel-order" data-id="<?php echo $data["order"]["secure_id"]; ?>" ><?php echo $ULang->t("Отменить"); ?></button>
             </div> 
             <div>
        ...
        <div class="modal-custom width600 animation-modal" >
         ...
         <div class="textarea-custom mt30" >
           ...
           <div class="textarea-custom-actions text-right" >
             <button class="button-style-custom color-green" ><?php echo $ULang->t("Добавить"); ?></button>
        ...
        <div class="modal-custom animation-modal" style="max-width: 600px;" >
         ...
         <form class="form-dispute-secure mt25" >
           ...
           <div class="row mt20" >
            ...
            <div class="modal-custom-button" >
               <div>
                 <button class="button-style-custom color-blue" ><?php echo $ULang->t("Открыть спор"); ?></button>
               </div> 
               <div>
