...
<?php if($settings["authorization_option"] == 1){ ?>
  ...
  <p class="text-center mb30" ><?php echo $ULang->t("по номеру телефона"); ?></p>
  ...
  <div class="auth-block-right-box-tab-1-2" >
    ...
    <input type="text"  class="form-control input-style2-custom" placeholder="Пароль из смс" maxlength="5" name="user_code_sms">
