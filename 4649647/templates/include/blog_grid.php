...
<div class="article-item" >
   <div class="article-item-image" > <a href="<?php echo $Blog->aliasArticle($value); ?>"> <img <?php if($value["blog_articles_image"]){ echo 'style="height: 115%"'; } ?> src="<?php echo Exists($config["media"]["big_image_blog"],$value["blog_articles_image"],$config["media"]["no_image"]); ?>" > </a> </div>
