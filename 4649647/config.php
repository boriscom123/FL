...
return [
   ...
   "db" => [
     "port" => "3310",
     "host" => "localhost",
     "database" => "modashopru_basrd",     
     "user" => "modashopru_basrd",
     "pass" => "YM&SNpd0",
     "charset" => "utf8",
   ],
   ...
   "media" => [
      ...
      "medium_image_ads" => "media/images_boards/big",
   ...
   "css_styles" => [
    ...
    '<link href="{urlPath}/templates/css/lightgallery.css" rel="stylesheet">',
		...
		'<link href="{urlPath}/templates/js/ion.rangeSlider-2.2.0/css/ion.rangeSlider.min.css" rel="stylesheet">',
   ...
   "js_plugins" => [
    ...
    '<script src="{urlPath}/templates/js/lightgallery.min.js"></script>',
		...
		'<script src="{urlPath}/templates/js/jquery.mousewheel.min.js"></script>',
		'<script src="{urlPath}/templates/js/ion.rangeSlider-2.2.0/js/ion.rangeSlider.min.js"></script>',
    ...
    '<script src="{urlPath}/templates/js/jquery.lazyload.min.js"></script>',
    [ 'ad_create'=> ['<script src="{urlPath}/templates/js/create.js"></script>'] ],
    [ 'ad_update'=> ['<script src="{urlPath}/templates/js/update.js"></script>'] ],
   ...
   "sms_services" => [
        ...
        "turbosms.ua" => [ "url" => "https://turbosms.ua", "param" => "id", "country" => "Украина" ],
