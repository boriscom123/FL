...
echo $Main->tpl("ad_view.tpl", compact( 'Seo','Geo','Main','visible_footer','Ads','route_name','list_services','data','Profile','languages_content','config','settings', 'CategoryBoard', 'getCategoryBoard', 'Filters', 'Banners', 'ULang', 'static_msg' ) );
